...
[![Version](https://img.shields.io/badge/version-0.2.0-blue.svg)](https://github.com/ZkIsHere/TeleCrate/releases)
...
1. Nhận diện kiến trúc hệ thống (`amd64` / `arm64`) và tải bản binary release `v0.2.0` mới nhất.
...
* [RELEASE_NOTES.md](RELEASE_NOTES.md) — Chi tiết các thay đổi trong phiên bản mới nhất v0.2.0.
