...
- **7.1: `implemented-and-tested` (2026-09-16)** — S3 Tool Conformance Suite (`tests/conformance_api.rs` & `tests/conformance.sh`), validating AWS CLI v2, rclone, and MinIO `mc` compatibility across lifecycle, pagination, multipart, presigned URLs, WORM locks, and delete markers.
